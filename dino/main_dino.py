...
def get_args_parser():
    ...
    parser.add_argument('--arch', default='vit_small', type=str,
        choices=['vit_tiny', 'vit_small', 'vit_base', 'xcit', 'deit_tiny', 'deit_small', 'resnet18d', 'efficientnetv2_s', 'efficientnetv2_m', 'efficientnetv2_l'] \
...
def train_dino(args):
    ...
    print(len(os.listdir(args.data_path)))
    ...
    # if the network is a XCiT
        ...
        student = timm.create_model(args.arch, pretrained=False, in_chans=3)
        teacher = timm.create_model(args.arch, pretrained=False, in_chans=3)
        embed_dim = student.fc.weight.shape[1]
    elif args.arch=='efficientnetv2_l':
        student = timm.create_model(args.arch, pretrained=False, in_chans=3)
        teacher = timm.create_model(args.arch, pretrained=False, in_chans=3)
